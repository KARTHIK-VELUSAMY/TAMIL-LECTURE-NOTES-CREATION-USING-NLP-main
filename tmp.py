...
toaddr = "karthik.it19@bitsathy.ac.in"#sys.argv[1]
print(toaddr)   
...
# files                                                                         
src = "C:/xampp/htdocs/img/upload/test.mp3"
dst = "C:/xampp/htdocs/img/upload/test22.wav"
...
try: 
     ...
     with open(name,"a", encoding="utf-8") as f:
         ...
         f.close()
         print("hii")
         fromaddr = "karthik.it19@bitsathy.ac.in"
         print(toaddr)
         msg = MIMEMultipart() 
         msg['From'] = fromaddr 
         msg['To'] = toaddr 
         ...
         s.starttls() 
         s.login(fromaddr, "Karthikvel@2002") 
         text = msg.as_string() 
